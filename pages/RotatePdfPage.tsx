...
const RotatePdfPage: React.FC<{ tool: Tool; onGoBack: () => void; }> = ({ tool, onGoBack }) => {
  ...
  useEffect(() => {
    ...
    updateMetaTags({
        title: 'Rotate PDF | Rotate PDF Pages Online for Free - PurePDF',
        description: 'Rotate your PDF files. Rotate all pages or just specific pages clockwise or counter-clockwise by 90, 180, or 270 degrees.',
        keywords: 'rotate pdf, pdf rotator, orient pdf, fix pdf orientation',
        canonicalUrl: pageUrl,
        jsonLd: {
            "@context": "https://schema.org",
            "@type": "HowTo",
            "name": "How to Rotate a PDF",
            "description": "Change the orientation of pages within a PDF document.",
            "step": [
                {
                    "@type": "HowToStep",
                    "name": "Select PDF",
                ...
                },
                {
                    "@type": "HowToStep",
                    "name": "Choose Options",
                    "text": "Select the rotation angle (90, 180, or 270 degrees) and specify which pages to rotate. Leave the pages field blank to rotate all pages.",
                    "url": pageUrl,
                },
                {
                    "@type": "HowToStep",
                    "name": "Rotate and Download",
                    "text": "Click 'Rotate PDF' to apply the changes and download your newly rotated document.",
                    "url": pageUrl,
                }
            ]
        }
      ...
      <div className="mt-10 relative">
        ...
        {!processedFileUrl ? (
          ...
          <div className="text-center p-8 bg-green-50 border border-green-200 rounded-xl">
              ...
              <h2 className="text-2xl font-bold text-green-800 mt-4">Rotation Successful!</h2>
              <p className="mt-2 text-green-600">Your PDF has been rotated and started downloading.</p>
              <a
              ...
              <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
                  <button onClick={handleStartOver} className="px-8 py-3 bg-blue-500 text-white text-base font-semibold rounded-lg shadow-md hover:bg-blue-600 transition-colors">
                      Rotate Another PDF
                  </button>

...
const PdfToJpgPage: React.FC<{ tool: Tool; onGoBack: () => void; }> = ({ tool, onGoBack }) => {
  ...
  useEffect(() => {
    ...
    updateMetaTags({
        title: 'PDF to JPG Converter | Convert PDF to Images Online - PurePDF',
        description: 'Extract all pages from a PDF into high-quality JPG images. Free online tool to convert PDFs to images, downloaded as a ZIP file.',
        keywords: 'pdf to jpg, pdf to image, convert pdf to jpg, pdf to picture',
        canonicalUrl: pageUrl,
        jsonLd: {
            "@context": "https://schema.org",
            "@type": "HowTo",
            "name": "How to Convert PDF to JPG",
            "description": "Convert every page of a PDF document into a high-quality JPG image.",
            "step": [
                {
                    "@type": "HowToStep",
                    "name": "Select PDF",
                    "text": "Upload the PDF file you want to convert to images.",
                    "url": pageUrl,
                },
                {
                    "@type": "HowToStep",
                    "name": "Convert",
                    "text": "Click the 'Convert to JPG' button to start the conversion process.",
                    "url": pageUrl,
                },
                {
                    "@type": "HowToStep",
                    "name": "Download",
                    "text": "A ZIP file containing all the converted JPG images will be automatically downloaded to your device.",
                    "url": pageUrl,
                }
            ]
        }
       ...
       <div className="mt-10 relative">
        ...
        {!processedFileUrl ? (
          ...
          <div className="text-center p-8 bg-green-50 border border-green-200 rounded-xl">
              ...
              <h2 className="text-2xl font-bold text-green-800 mt-4">Conversion Successful!</h2>
              <p className="mt-2 text-green-600">Your images have been created and started downloading as a ZIP file.</p>
              <a
              ...
              <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
                  <button onClick={handleStartOver} className="px-8 py-3 bg-fuchsia-500 text-white text-base font-semibold rounded-lg shadow-md hover:bg-fuchsia-600 transition-colors">
                      Convert Another PDF
                  </button>

...
const MOCK_POSTS: Post[] = [
  {
    ...
    tags: ['merging', 'organization', 'efficiency'],
  },
  {
    id: '2',
    ...
    tags: ['compression', 'optimization', 'file size'],
  },
  {
    id: '3',
  ...
  },
   {
    ...
    tags: ['organization', 'editing', 'efficiency'],
  },
   {
    id: '5',
    ...
    tags: ['editing', 'security', 'productivity', 'organization', 'tips'],
  },
  {
    id: '6',
    title: 'The Ultimate Guide to Digital Document Workflows in 2024',
    description: `In today's fast-paced digital landscape, mastering your document workflow is no longer a luxury—it's a necessity. From solo entrepreneurs to large corporations, the ability to create, manage, and share documents efficiently can dramatically impact productivity and security. This guide will walk you through building a robust digital document workflow using modern tools and best practices.\n\n**Step 1: Standardize Your Creation Process**\n\nThe foundation of any good workflow is consistency. Start by standardizing the format you use for shareable documents. The PDF is the universal standard for a reason: it maintains formatting across all devices and operating systems. When creating documents in other applications like Word or image editors, make it a habit to convert them to PDF before sharing. Our **Image to PDF** and (upcoming) **Word to PDF** tools are perfect for this.\n\n**Step 2: Organize and Consolidate**\n\nScattered files are the enemy of efficiency. Before sending out a project, proposal, or report, consolidate all related parts into a single document. Use our **Merge PDF** tool to combine everything from cover pages and appendices to invoices and images into one cohesive file. This not only looks more professional but also prevents recipients from losing track of attachments.\n\n**Step 3: Secure and Protect Your Information**\n\nNot all documents are meant for public eyes. When dealing with sensitive information, security is paramount. This can involve two key actions:\n\n- **Watermarking:** For documents that are proprietary but need to be shared (like drafts or previews), use the **Add Watermark** tool. A "Confidential" or "Draft" stamp clearly communicates the document's status and discourages unauthorized use.\n- **Password Protection:** For highly sensitive files, add a password. (Note: A "Protect PDF" tool for this would be the next logical feature to build!)\n\nConversely, if you receive a file that you have the authority to access but is locked for printing or editing, our **Unlock PDF** tool can remove those restrictions, provided you have the password.\n\n**Step 4: Optimize for Distribution**\n\nLarge files can clog email inboxes and be slow to download. Before you hit send, run your finalized PDF through the **Compress PDF** tool. It intelligently reduces the file size by optimizing images and removing redundant data, often without any noticeable loss in quality. This simple step makes sharing and archiving much smoother.\n\n**Step 5: Review, Edit, and Finalize**\n\nNo document is perfect on the first try. A final review stage is crucial. What if you spot a typo or need to add a last-minute annotation? Instead of going back to the source file, you can make quick changes directly with our **Edit PDF** tool. Add text, highlight sections, or even reorder pages with the **Organize PDF** tool to get everything just right. A seamless review cycle is the hallmark of a mature document workflow. By integrating these steps and tools into your daily routine, you can transform a chaotic and time-consuming process into a streamlined, secure, and professional workflow.`,
    author: 'Ornob',
    date: 'November 05, 2023',
    tags: ['workflows', 'productivity', 'document management', 'security'],
  },
  {
    id: '7',
    title: 'unga bunga',
